#include "fm_algo.h"
float fm_algo0000(fm_voice_t *voice, const float feedback_amp) {
...
float fm_algo0100(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo0200(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo0300(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo0400(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo0500(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo0600(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo0700(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo0800(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo0900(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo1000(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo1100(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
...
float fm_algo1200(fm_voice_t *voice, const float feedback_amp) {
    voice->op_states[3].output = fm_calc_op(
        voice->op_states[3].phase,
        voice->op_states[3].expression
    );
